...
# Why Study (a) Craft of Programming and (b) Minimalist Programming Methods

Q: Can't AI do it all?      
A: [Nope](https://docs.google.com/presentation/d/1mR4jzEWzN5IQdtfSIovU2-YbEcvCZoaPAp5vDBFejqI/edit?slide=id.g3824839c8bf_4_29#slide=id.g3824839c8bf_4_29)

- Cause in this age of LLMs, reviewing code is a power skill
- Cause we are proud engineers and engineers know their tools better
than anyone else
  -  Doctors don't learn operations from Google. They get in there, and muck around
- Cause when sh\*t happens, who you going to call?
  - Cloudflare (Nov 2025): 3-hour web outage, ~$1.6B lost in trading volume.
   operations via google
